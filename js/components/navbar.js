    ...
    function getLogoForPage() {
        switch(currentPage) {
            case 'kadernictvi-kosmetika.html':
                return 'https://res.cloudinary.com/dlvunn4yc/image/upload/h_60/f_auto/q_auto/v1759231005/NaisyKaKSalonLogo_qzgft0.png';
            case 'naisy-gentleman.html':
                return 'https://res.cloudinary.com/dlvunn4yc/image/upload/h_60/f_auto/q_auto/v1759230978/NaisyGentlemanLogo_r9srwi.png';
